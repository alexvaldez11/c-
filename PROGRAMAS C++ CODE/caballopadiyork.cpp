#include <stdio.h>
 ...
 int contador = 1; // Esta variable lleva la cuenta de las casillas
                   // recorridas
 long int ciclos = 0; // Esta variable cuenta los ciclos que se intentan
                 // antes de terminar que ya no haya lugares a los cuales
                 // ir
 long int intentos_fallidos = 0; // Esta variable cuenta cuantos ciclos se
 ...
 printf("\nSe intentaron %f circuitos antes de obtener", intentos_fallidos);
 printf(" el requerido.\n");
